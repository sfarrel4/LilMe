        ...
        <section class="content">
		  ...
		  <div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title">Add a Child</h3>
                  <h3>${param.message}</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                <form role="form" action="/add-child" method="post">
                  <div class="box-body">
					...
					<div class="form-group">
                      ...
                      <input type="text" class="form-control" name="middleInitial" placeholder="Middle Initial" maxlength="1">
                    </div>
					<div class="form-group">
					...
					<div class="form-group">
                      <label>Lunch Group</label>
                      <select class="form-control" name="lunchGroup">
					...
					<div>
    					<input type="hidden" name="url" value="adminAddChild.jsp">
    				</div>
