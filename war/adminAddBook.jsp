          ...
          <ul class="sidebar-menu">
			...
			<li class="treeview">
				...
				<ul class="treeview-menu">
					<li><a href="adminSendUpdate.jsp"><i class="fa fa-circle-o"></i>Send Update Email</a></li>
				</ul>
			</li>
            <li class="treeview">
              <a href="#">
              ...
              <ul class="treeview-menu">
                <li><a href="adminAddChild.jsp"><i class="fa fa-circle-o"></i>Add Child</a></li>
                <li><a href="adminAddParent.jsp"><i class="fa fa-circle-o"></i>Add Parent</a></li>
				<li><a href="adminAddBook.jsp"><i class="fa fa-circle-o"></i>Add Book</a></li>
			 </ul>
            </li>
            <li class="treeview">
              <a href="#">
      ...
      <div class="content-wrapper">
        ...
        <section class="content">
		  ...
		  <div class="box box-primary">
                ...
                <!-- form start -->
                <form role="form" action="/add-book" method="post" id="bookForm">
                  <div class="box-body">
					...
					<div class="form-group">
                      ...
                      <textarea class="form-control" rows="3" name="bookSynop" form="bookForm" placeholder="Enter the Book Synopsis..."></textarea>
					</div>
					
					<div class="form-group">
                      <label>Book Lessons</label>
                      <textarea class="form-control" rows="3" name="bookLessons" form="bookForm" placeholder="Enter the Book Lessons..."></textarea>
					</div>
					
					<div class="form-group">
                      <label>Book Questions</label>
                      <textarea class="form-control" rows="3" name="bookQuestions" form="bookForm" placeholder="Enter the Book Questions..."></textarea>
					</div>
					
					<div class="form-group">
                      <label>Book Image URL</label>
                      <input type="text" class="form-control" name="bookImageURL" placeholder="URL">
                    </div>				 
                     <div>
    					<input type="hidden" name="url" value="adminAddBook.jsp">
    				</div>
